...
!function(a, b, c) {
        ...
        a.extend(a.mobile, {
            ...
            resetActivePageHeight: function(b) {
                var c = a("." + a.mobile.activePageClass)
                  , d = c.height()
                  , e = c.outerHeight(!0);
                b = "number" == typeof b ? b : a.mobile.getScreenHeight(),
                c.css("min-height", b - (e - d))
            },
            loading: function() {
    ...
    function(a, d) {
        ...
        ,
        a.mobile.ajaxBlacklist = b.blackberry && !b.WebKitPoint || s || m,
        m && a(function() {
    ...
    function(a, c) {
        ...
        a.mobile.path = d = {
            ...
            getLocation: function(a) {
                ...
                return c = "#" === c ? "" : c,
                b.protocol + "//" + b.host + b.pathname + b.search + c
            },
            ...
            squash: function(a, b) {
                ...
                h ? ((d.isPath(j) || 0 === j.replace("#", "").indexOf(this.uiStateKey)) && (j = ""),
                k && -1 === j.indexOf(this.uiStateKey) && (j += k),
                -1 === j.indexOf("#") && "" !== j && (j = "#" + j),
                c = d.parseUrl(c),
                c = c.protocol + "//" + c.host + c.pathname + f + j) : c += c.indexOf("#") > -1 ? k : "#" + k,
                c
            },
        ...
        a.extend(a.mobile.Navigator.prototype, {
            ...
            popstate: function(b) {
                ...
                if (a.event.special.navigate.isPushStateEnabled())
                    ...
                    void 0) : !b.originalEvent.state && 1 === this.history.stack.length && this.ignoreInitialHashChange && (this.ignoreInitialHashChange = !1,
                    location.href === e) ? (b.preventDefault(),
    ...
    function(a) {
        ...
        a.event.special.scrollstart = {
            ...
            setup: function() {
                function c(a, c) {
                    d = c,
                    b(g, d ? "scrollstart" : "scrollstop", a)
                }
                var d, e, g = this, h = a(g);
                h.bind(f, function(b) {
                    a.event.special.scrollstart.enabled && (d || c(b, !0),
                    clearTimeout(e),
        ...
        a.event.special.tap = {
            ...
            setup: function() {
                ...
                e.bind("vmousedown", function(g) {
                    ...
                    function i() {
                        h(),
                        e.unbind("vclick", j).unbind("vmouseup", h),
                        d.unbind("vmousecancel", i)
                    }
                    function j(a) {
                        i(),
                        f || l !== a.target ? f && a.stopPropagation() : b(c, "tap", a)
                    }
                    if (f = !1,
                    g.which && 1 !== g.which)
                        return !1;
                    var k, l = g.target;
                    e.bind("vmouseup", h).bind("vclick", j),
                    d.bind("vmousecancel", i),
                    k = setTimeout(function() {
                        a.event.special.tap.emitTapOnTaphold || (f = !0),
                        b(c, "taphold", a.Event("taphold", {
                            target: l
                        }))
        ...
        a.event.special.swipe = {
            ...
            setup: function() {
                ...
                c.bind(g, function(d) {
                    function e(c) {
                        g && (f = a.event.special.swipe.stop(c),
                        k || (k = a.event.special.swipe.handleSwipe(g, f, b, j)),
                        Math.abs(g.coords[0] - f.coords[0]) > a.event.special.swipe.scrollSupressionThreshold && c.preventDefault())
                    }
            ...
            rewrite: function(b, d) {
                ...
                d.find(c.linkSelector).each(function(b, c) {
                    var d = a(c).is("[href]") ? "href" : a(c).is("[src]") ? "src" : "action"
                      , f = a(c).attr(d);
                    f = f.replace(location.protocol + "//" + location.host + location.pathname, ""),
                    /^(\w+:|#|\/)/.test(f) || a(c).attr(d, e + f)
                })
            },
            reset: function() {
    ...
    function(a, b) {
        ...
        a.widget("mobile.page", {
            ...
            _create: function() {
                ...
                "dialog" === a.mobile.getAttribute(this.element[0], "role") && a.mobile.dialog && this.element.dialog(),
                void 0)
            },
            _enhance: function() {
            ...
            _setOptions: function(c) {
                c.theme !== b && this.element.removeClass("ui-body-" + this.options.theme).addClass("ui-body-" + c.theme),
    ...
    function(a, d) {
        a.widget("mobile.pagecontainer", {
            ...
            _handleDestination: function(b) {
                ...
                b === a.mobile.path.makeUrlAbsolute("#" + c.initialDst, this._getDocumentBase()) && c.stack.length && c.stack[0].url !== c.initialDst.replace(a.mobile.dialogHashKey, "") && (b = this._getInitialContent())),
                b || this._getInitialContent()
            },
            _handleDialog: function(b, c) {
                var d, e, f = this.getActivePage();
                return f && !f.hasClass("ui-dialog") ? ("back" === c.direction ? this.back() : this.forward(),
                !1) : (d = c.pageUrl,
            ...
            _handleNavigate: function(b, c) {
                ...
                f.activeIndex > 0 && e.indexOf(a.mobile.dialogHashKey) > -1 && f.initialDst !== e && (e = this._handleDialog(h, c),
                e === !1) || this._changeContent(this._handleDestination(e), h)
            },
            ...
            _find: function(b) {
                ...
                return c = this.element.children("[data-" + this._getNs() + "url='" + e + "']"),
            ...
            _parse: function(b, c) {
                ...
                d.attr("data-" + this._getNs() + "url", a.mobile.path.convertUrlToDataUrl(c)).attr("data-" + this._getNs() + "external-page", !0),
                d
            },
            ...
            _loadSuccess: function(b, c, e, f) {
                ...
                return a.proxy(function(i, j, k) {
                    ...
                    m.test(i) && RegExp.$1 && n.test(RegExp.$1) && RegExp.$1 && (g = a.mobile.path.getFilePath(a("<div>" + RegExp.$1 + "</div>").text())),
                    e.prefetch === d && this._getBase().set(g),
                    l = this._parse(i, g),
                    this._setLoadedTitle(l, i),
                    c.xhr = k,
                    c.textStatus = j,
                    c.page = l,
                    c.content = l,
                    this._trigger("load", d, c) && (this._isRewritableBaseTag() && l && this._getBase().rewrite(g, l),
                    this._include(l, e),
                    b.indexOf("&" + a.mobile.subPageUrlKey) > -1 && (l = this.element.children("[data-" + this._getNs() + "url='" + h + "']")),
            ...
            load: function(b, c) {
                ...
                return j.reload = j.reloadPage,
                j.data && "get" === j.type && (l = a.mobile.path.addSearchParams(l, j.data),
                j.data = d),
                j.data && "post" === j.type && (j.reload = !0),
                e = this._createFileUrl(l),
                f = this._createDataUrl(l),
                k = this._find(l),
                0 === k.length && a.mobile.path.isEmbeddedPage(e) && !a.mobile.path.isFirstPageUrl(e) ? (i.reject(l, j),
                void 0) : (this._getBase().reset(),
                k.length && !j.reload ? (this._enhance(k, j.role),
                i.resolve(l, j, k),
                ...
                g.deprecatedEvent.isDefaultPrevented() || g.event.isDefaultPrevented() ? void 0 : (j.showLoadMsg && this._showLoading(j.loadMsgDelay),
                j.prefetch === d && this._getBase().reset(),
                a.mobile.allowCrossDomainPages || a.mobile.path.isSameDomain(a.mobile.path.documentUrl, l) ? (a.ajax({
                    url: e,
                    type: j.type,
                    data: j.data,
            ...
            transition: function(b, g, h) {
                ...
                if (f)
                    ...
                    void 0;
                if (this._triggerPageBeforeChange(b, g, h) && (v = this._triggerWithDeprecated("beforetransition", g),
                !v.deprecatedEvent.isDefaultPrevented() && !v.event.isDefaultPrevented())) {
                    ...
                    0 === a.mobile.navigate.history.activeIndex && j === a.mobile.navigate.history.initialDst && (j += a.mobile.dialogHashKey)),
                    ...
                    h.changeHash !== !1 && a.mobile.hashListeningEnabled ? a.mobile.navigate(j, t, !0) : b[0] !== a.mobile.firstPage[0] && a.mobile.navigate.history.add(j, t)),
                    c.title = p,
    ...
    function(a, c) {
        ...
        a.fn.animationComplete = function(b) {
            return a.support.cssTransitions ? a(this).one("webkitAnimationEnd animationend", b) : (setTimeout(b, 0),
            a(this))
        }
        ,
        ...
        a.mobile._registerInternalEvents = function() {
            var e = function(b, c) {
                ...
                i = (b.attr("method") || "get").toLowerCase(),
                d || (d = a.mobile.getClosestBaseUrl(b),
                "get" === i && (d = a.mobile.path.parseUrl(d).hrefNoSearch),
                d === a.mobile.path.documentBase.hrefNoHash && (d = f.hrefNoSearch)),
                d = a.mobile.path.makeUrlAbsolute(d, a.mobile.getClosestBaseUrl(b)),
                a.mobile.path.isExternal(d) && !a.mobile.path.isPermittedCrossDomainRequest(f, d) ? !1 : (c || (e = b.serializeArray(),
                g && g[0].form === b[0] && (h = g.attr("name"),
                h && (a.each(e, function(a, b) {
                    return b.name === h ? (h = "",
                    !1) : void 0
                }),
                h && e.push({
            ...
            a.mobile.document.delegate("form", "submit", function(b) {
                var c;
                b.isDefaultPrevented() || (c = e(a(this)),
                c && (a.mobile.changePage(c.url, c.options),
                b.preventDefault()))
            }),
            a.mobile.document.bind("vclick", function(b) {
                ...
                if (!(b.which > 1) && a.mobile.linkBindingEnabled) {
                    if (g = a(h),
                    a.data(h, "mobile-button")) {
                        if (!e(a(h).closest("form"), !0))
                            return;
                        h.parentNode && (h = h.parentNode)
                    } else {
                        if (h = d(h),
                        !h || "#" === a.mobile.path.parseUrl(h.getAttribute("href") || "#").hash)
                            return;
                        if (!a(h).jqmHijackable().length)
                            return
                    }
                    ~h.className.indexOf("ui-link-inherit") ? h.parentNode && (f = a.data(h.parentNode, "buttonElements")) : f = a.data(h, "buttonElements"),
                    f ? h = f.outer : i = !0,
                    c = a(h),
                    i && (c = c.closest(".ui-btn")),
                    c.length > 0 && !c.hasClass("ui-state-disabled") && (a.mobile.removeActiveLinkClass(!0),
                    a.mobile.activeClickedLink = c,
            ...
            a.mobile.document.bind("click", function(e) {
                if (a.mobile.linkBindingEnabled && !e.isDefaultPrevented()) {
                    ...
                    if (a.mobile.activeClickedLink && a.mobile.activeClickedLink[0] === e.target.parentNode && p(),
                    n && !(e.which > 1) && o.jqmHijackable().length) {
                        if (o.is(":jqmData(rel='back')"))
                            return a.mobile.back(),
                            !1;
                        if (g = a.mobile.getClosestBaseUrl(o),
                        h = a.mobile.path.makeUrlAbsolute(o.attr("href") || "#", g),
                        !a.mobile.ajaxEnabled && !a.mobile.path.isEmbeddedPage(h))
                            return p(),
                            void 0;
                        if (-1 !== h.search("#")) {
                            if (h = h.replace(/[^#]*#/, ""),
                        ...
                        m = o.attr("data-" + a.mobile.ns + "rel") || c,
    ...
    function(a, b) {
        ...
        a.extend(a.mobile.Transition.prototype, {
            ...
            transition: function() {
                ...
                this.toggleViewportClass(),
                this.$from && !e ? this.startOut(c, b, e) : this.doneOut(c, b, e, !0),
    ...
    function(a, b) {
        ...
        a.widget("mobile.collapsible", {
            ...
            _create: function() {
                ...
                this.options.enhanced ? (c.heading = a(".ui-collapsible-heading", this.element[0]),
                c.content = c.heading.next(),
                c.anchor = a("a", c.heading[0]).first(),
            ...
            _enhance: function(b, c) {
                ...
                return b.addClass("ui-collapsible " + (e.inset ? "ui-collapsible-inset " : "") + (e.inset && e.corners ? "ui-corner-all " : "") + (f ? "ui-collapsible-themed-content " : "")),
                c.originalHeading = b.children(this.options.heading).first(),
                c.content = b.wrapInner("<div class='ui-collapsible-content " + f + "'></div>").children(".ui-collapsible-content"),
                ...
                d = e.collapsed ? e.collapsedIcon ? "ui-icon-" + e.collapsedIcon : "" : e.expandedIcon ? "ui-icon-" + e.expandedIcon : "",
                c.status = a("<span class='ui-collapsible-heading-status'></span>"),
                c.anchor = c.heading.detach().addClass("ui-collapsible-heading").append(c.status).wrapInner("<a href='#' class='ui-collapsible-heading-toggle'></a>").find("a").first().addClass("ui-btn " + (d ? d + " " : "") + (d ? "ui-btn-icon-" + ("right" === e.iconpos ? "right" : "left") + " " : "") + this._themeClassFromOption("ui-btn-", e.theme) + " " + (e.mini ? "ui-mini " : "")),
            ...
            _setOptions: function(a) {
                ...
                c = g.hasClass("ui-collapsible-collapsed"),
                c ? (l.expandCueText !== b && k.text(l.expandCueText),
                l.collapsedIcon !== b && (h.collapsedIcon && j.removeClass("ui-icon-" + h.collapsedIcon),
                l.collapsedIcon && j.addClass("ui-icon-" + l.collapsedIcon))) : (l.collapseCueText !== b && k.text(l.collapseCueText),
                l.expandedIcon !== b && (h.expandedIcon && j.removeClass("ui-icon-" + h.expandedIcon),
                l.expandedIcon && j.addClass("ui-icon-" + l.expandedIcon))),
                l.iconpos !== b && (j.removeClass("ui-btn-icon-" + ("right" === h.iconPos ? "right" : "left")),
                j.addClass("ui-btn-icon-" + ("right" === l.iconPos ? "right" : "left"))),
                l.theme !== b && (e = this._themeClassFromOption("ui-btn-", h.theme),
                d = this._themeClassFromOption("ui-btn-", l.theme),
                j.removeClass(e).addClass(d)),
                l.contentTheme !== b && (e = this._themeClassFromOption("ui-body-", h.theme),
                d = this._themeClassFromOption("ui-body-", l.theme),
                i.content.removeClass(e).addClass(d)),
                l.inset !== b && (g.toggleClass("ui-collapsible-inset", l.inset),
                f = !(!l.inset || !l.corners && !h.corners)),
                l.corners !== b && (f = !(!l.corners || !l.inset && !h.inset)),
                f !== b && g.toggleClass("ui-corner-all", f),
                l.mini !== b && j.toggleClass("ui-mini", l.mini),
                this._super(a)
            },
    ...
    function(a) {
        a.mobile.behaviors.addFirstLastClasses = {
            _getVisibles: function(a, b) {
                var c;
                return b ? c = a.not(".ui-screen-hidden") : (c = a.filter(":visible"),
                0 === c.length && (c = a.not(".ui-screen-hidden"))),
                c
            },
        ...
        a.widget("mobile.listview", a.extend({
            ...
            refresh: function(c) {
                ...
                f = w.length; f > e; e++)
                    ...
                    q.attr("title", a.trim(q.getEncodedText())).addClass(u).empty()) : k && (d += " ui-btn-icon-right ui-icon-" + k),
                    l.first().addClass(d)) : m ? (v = b(g[0], "theme") || x.dividerTheme || x.theme,
    ...
    function(a, b) {
        a.widget("mobile.checkboxradio", a.extend({
            ...
            _create: function() {
                ...
                c.iconpos = d(b, "iconpos") || f.attr("data-" + a.mobile.ns + "iconpos") || c.iconpos,
            ...
            _enhance: function() {
                ...
                this.parentLabel.length > 0 ? this.input.add(this.label).wrapAll(this._wrapper()) : (this.element.wrap(this._wrapper()),
            ...
            _handleInputVClick: function() {
                var a = this.element;
                a.is(":checked") ? (a.prop("checked", !0),
                this._getInputSet().not(a).prop("checked", !1)) : a.prop("checked", !1),
                this._updateAll()
            },
    ...
    function(a, b) {
        a.widget("mobile.button", {
            ...
            refresh: function(b) {
                if (this.options.icon && "notext" === this.options.iconpos && this.element.attr("title") && this.element.attr("title", this.element.val()),
                !b) {
    ...
    function(a, d) {
        a.widget("mobile.slider", a.extend({
            ...
            _sliderVMouseUp: function() {
                ...
                this.mouseMoved ? this.userModified ? this.refresh(0 === this.beforeStart ? 1 : 0) : this.refresh(this.beforeStart) : this.refresh(0 === this.beforeStart ? 1 : 0)),
                this.mouseMoved = !1,
                this._trigger("stop"),
                !1) : void 0
            },
            ...
            refresh: function(b, d, e) {
                ...
                this._labels && (v = 100 * (this.handle.width() / this.slider.width()),
                w = k && v + (100 - v) * k / 100,
            ...
            _setDisabled: function(a) {
                ...
                this.slider.toggleClass("ui-state-disabled").attr("aria-disabled", a)
            }
        }, a.mobile.behaviors.formReset))
    }(a),
    function(a) {
        ...
        a.widget("mobile.slider", a.mobile.slider, {
            ...
            _setOption: function(a, c) {
                this._super(a, c),
                "showValue" === a ? this.handle.html(c && !this.options.mini ? this._value() : "") : "popupEnabled" === a && c && !this._popup && (this._popup = b().addClass("ui-body-" + (this.options.theme || "a")).insertBefore(this.element))
            },
            refresh: function() {
            ...
            _refresh: function() {
                ...
                this._popup.html(a)) : b.showValue && !this.options.mini && this.handle.html(a))
            },
            _showPopup: function() {
    ...
    function(a, b) {
        a.widget("mobile.flipswitch", a.extend({
            ...
            _destroy: function() {
                this.options.enhanced || (this.on.remove(),
                this.off.remove(),
                this.element.unwrap(),
    ...
    function(a, b) {
        a.widget("mobile.textinput", a.mobile.textinput, {
            ...
            _setOptions: function(a) {
                ...
                a.clearBtnText !== b && this._clearBtn !== b && this._clearBtn.text(a.clearBtnText)
            },
        ...
        a.widget("mobile.popup", {
            ...
            _handleDocumentFocusIn: function(b) {
                ...
                if (this._isOpen) {
                    if (d !== e.container[0]) {
                        if (c = a(d),
                        0 === c.parents().filter(e.container[0]).length)
            ...
            _animate: function(b) {
                ...
                this._fallbackTransition) ? (this._ui.container.animationComplete(a.proxy(b.prerequisites.container, "resolve")).addClass(b.containerClassToAdd).removeClass(b.classToRemove),
                void 0) : (this._ui.container.removeClass(b.classToRemove),
                b.prerequisites.container.resolve(),
                void 0)
            },
            ...
            open: function(b) {
                ...
                0 === h.activeIndex && c === h.initialDst && (c += d),
    ...
    function(a, b) {
        ...
        a.widget("mobile.selectmenu", a.mobile.selectmenu, {
            ...
            _handleButtonVclickKeydown: function(b) {
                this.options.disabled || this.isOpen || ("vclick" === b.type || b.keyCode && (b.keyCode === a.mobile.keyCode.ENTER || b.keyCode === a.mobile.keyCode.SPACE)) && (this._decideFormat(),
            ...
            build: function() {
                ...
                this.list.delegate("li:not(.ui-disabled,.ui-state-disabled,.ui-li-divider)", "click", function(b) {
                    ...
                    e.selected = u.isMultiple ? !e.selected : !0,
                    u.isMultiple && a(this).find("a").toggleClass("ui-checkbox-on", e.selected).toggleClass("ui-checkbox-off", !e.selected),
                    (u.isMultiple || c !== d) && u.select.trigger("change"),
                    u.isMultiple ? u.list.find("li:not(.ui-li-divider)").eq(d).find("a").first().focus() : u.close(),
                    b.preventDefault()
                }),
            ...
            refresh: function(b) {
                ...
                c.setButtonText(),
                c.setButtonCount(),
                c.list.find("li:not(.ui-li-divider)").find("a").removeClass(a.mobile.activeBtnClass).end().attr("aria-selected", !1).each(function(b) {
                    if (a.inArray(b, d) > -1) {
                        var e = a(this);
                        e.attr("aria-selected", !0),
                        c.isMultiple ? e.find("a").removeClass("ui-checkbox-off").addClass("ui-checkbox-on") : e.hasClass("ui-screen-hidden") ? e.next().find("a").addClass(a.mobile.activeBtnClass) : e.find("a").addClass(a.mobile.activeBtnClass)
                    }
                }),
                void 0)
            },
            ...
            _decideFormat: function() {
                ...
                b.menuPage.find("div .ui-title").text(b.label.text())) : (b.menuType = "overlay",
                b.listbox.one({
    ...
    function(a, b) {
        a.widget("mobile.toolbar", {
            ...
            _setOptions: function(c) {
                if (c.addBackBtn !== b && (this.options.addBackBtn && "header" === this.role && a(".ui-page").length > 1 && this.page[0].getAttribute("data-" + a.mobile.ns + "url") !== a.mobile.path.stripHash(location.hash) && !this.leftbtn ? this._addBackButton() : this.element.find(".ui-toolbar-back-btn").remove()),
                null != c.backBtnTheme && this.element.find(".ui-toolbar-back-btn").addClass("ui-btn ui-btn-" + c.backBtnTheme),
                c.backBtnText !== b && this.element.find(".ui-toolbar-back-btn .ui-btn-text").text(c.backBtnText),
                c.theme !== b) {
            ...
            _btnMarkup: function() {
                this.element.children("a").attr("data-" + a.mobile.ns + "role", "button"),
            ...
            _addBackButton: function() {
                ...
                this.backBtn || (b = c.backBtnTheme || c.theme,
                this.backBtn = a("<a role='button' href='javascript:void(0);' class='ui-btn ui-corner-all ui-shadow ui-btn-left " + (b ? "ui-btn-" + b + " " : "") + "ui-toolbar-back-btn ui-icon-carat-l ui-btn-icon-left' " + "data-" + a.mobile.ns + "rel='back'>" + c.backBtnText + "</a>").prependTo(this.element))
            },
    ...
    function(a, b) {
        a.widget("mobile.toolbar", a.mobile.toolbar, {
            ...
            _destroy: function() {
                ...
                a.closest(".ui-page").css("padding-" + (b ? "top" : "bottom"), ""),
    ...
    function(a, b) {
        ...
        a.widget("mobile.popup", a.mobile.popup, {
            ...
            _placementCoords: function(b) {
                ...
                e ? (m.ct.removeClass("ui-popup-arrow-l ui-popup-arrow-t ui-popup-arrow-r ui-popup-arrow-b").addClass("ui-popup-arrow-" + e.dir).removeAttr("style").css(e.posProp, e.posVal).show(),
                d || (i = this.element.offset(),
                k[g[e.dir].fst] = m.ct.offset(),
                k[g[e.dir].snd] = {
    ...
    function(a, c) {
        a.widget("mobile.panel", {
            ...
            _getWrapper: function() {
                ...
                return 0 === a.length && (a = this._page().children(".ui-header:not(.ui-header-fixed), .ui-content:not(.ui-popup), .ui-footer:not(.ui-footer-fixed)").wrapAll("<div class='" + this.options.classes.pageWrapper + "'></div>").parent()),
                a
            },
            ...
            _positionPanel: function() {
                ...
                b.scrollTo(0, a.mobile.defaultHomeScroll)) : c._fixPanel()
            },
            ...
            _handleClick: function(b) {
                if (b.currentTarget.href.split("#")[1] === this._panelID && this._panelID !== c) {
                    b.preventDefault();
                    var d = a(b.target);
                    return d.hasClass("ui-btn") && (d.addClass(a.mobile.activeBtnClass),
                ...
                if (!this._open) {
                    var c = this
                      ...
                      , e = function() {
                        ...
                        !b && a.support.cssTransform3d && d.animate ? c.document.on(c._transitionEndEvents, f) : setTimeout(f, 0),
                      ...
                      , f = function() {
                        c.document.off(c._transitionEndEvents, f),
                        "overlay" !== d.display && (c._wrapper().addClass(d.classes.pageContentPrefix + "-open"),
                        c._fixedToolbars().addClass(d.classes.pageContentPrefix + "-open")),
                        c._bindFixListener(),
                        c._trigger("open")
                    };
                    c._trigger("beforeopen"),
                    "open" === c._page().jqmData("panel") ? c.document.on("panelclose", function() {
                        e()
                    }) : e(),
                    c._open = !0
                }
            ...
            _destroy: function() {
                ...
                this._open && (this.document.off(this._transitionEndEvents),
                a.mobile.resetActivePageHeight())),
                this._open && this._page().jqmRemoveData("panel"),
                this._panelInner.children().unwrap(),
                this.element.removeClass([this._getPanelClasses(), c.classes.panelOpen, c.classes.animate].join(" ")).off("swipeleft.panel swiperight.panel").off("panelbeforeopen").off("panelhide").off("keyup.panel").off("updatelayout").off(this._transitionEndEvents),
    ...
    function(a) {
        a.widget("mobile.table", a.mobile.table, {
            ...
            _create: function() {
                ...
                this._bindToggles(this._menu)) : (this._menu = this._enhanceColToggle(),
            ...
            _addToggles: function(b, c) {
                ...
                this.headers.not("td").each(function() {
                    ...
                    h && (i.addClass(f.classes.priorityPrefix + h),
                    (c ? d.eq(e++) : a("<label><input type='checkbox' checked />" + (b.children("abbr").first().attr("title") || b.text()) + "</label>").appendTo(g).children(0).checkboxradio({
            ...
            _menuInputChange: function(b) {
                ...
                c[0].getAttribute("locked") ? (c.removeAttr("locked"),
                this._unlockCells(c.jqmData("cells"))) : c.attr("locked", !0)
            },
            ...
            _refresh: function(a) {
                this._super(a),
                a || "columntoggle" !== this.options.mode || (this._unlockCells(this.allHeaders),
            ...
            _filterItems: function(b) {
                ...
                if (null != b)
                    ...
                    c = 0; f > c; c++)
                        ...
                        g.push(k[c]);
                0 === i.length ? k[j.filterReveal ? "addClass" : "removeClass"]("ui-screen-hidden") : (a(i).addClass("ui-screen-hidden"),
    ...
    function(a, b) {
        ...
        a.extend(a.mobile, {
            initializePage: function() {
                ...
                d(),
                a.mobile.hashListeningEnabled && a.mobile.path.isHashValid(location.hash) && (a(h).is(":jqmData(role='page')") || a.mobile.path.isPath(g) || g === a.mobile.dialogHashKey) ? a.event.special.navigate.isPushStateEnabled() ? (a.mobile.navigate.history.stack = [],
                a.mobile.navigate(a.mobile.path.isPath(location.hash) ? location.hash : location.href)) : f.trigger("hashchange", [!0]) : (a.mobile.path.isHashValid(location.hash) && (a.mobile.navigate.history.initialDst = g.replace("#", "")),
                a.event.special.navigate.isPushStateEnabled() && a.mobile.navigate.navigator.squash(b.parseLocation().href),
